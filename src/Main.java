/*
* Classe de exemplo para exercicios propostos na aula 3 de arrays.
*/
...
public class Main {
    public static void main(String[] args) {
        ...
        String[][] nomesSobrenome = new String[][] {{"Rayne","Marquez"},{"Paulo","Moreira"}};

        for (String[] nomesCompleto: nomesSobrenome) {
            for (String nomesC: nomesCompleto) {
                System.out.print(nomesC + " ");
            }
            System.out.println();
        }
    }
